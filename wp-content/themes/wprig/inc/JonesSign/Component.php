...
JSONLD;
	...
	public function get_jones_icon() {
		...
		xml:space="preserve">
			<circle id="icon_circle" class="logo_circle_fill" cx="251" cy="250" r="240"/>
			<path id="icon_j" class="logo_letter_fill" d="M187.3,328.6h103.8V107H364v215.6c0,17.9-2.1,42-15.2,55.1c-13.1,13.4-37.6,15.3-54.9,15.3H184.1 c-17.3,0-41.9-1.9-55.1-15.3c-13-13.2-15.1-37.3-15.1-55.1v-59.2h73.3V328.6z"/>
		</svg>
ICO;
		return $icon;
	}
