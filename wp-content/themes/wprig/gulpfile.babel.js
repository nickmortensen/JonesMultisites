...
export const firstRun = series(
    cleanCSS, cleanJS, parallel(php, images, series( styles, editorStyles, adminStyles ), scripts), serve, watch
);
...
export const buildDev = parallel(
   php, images, series( styles, editorStyles, adminStyles ), scripts, translate
    // php, images, styles, editorStyles, adminStyles, scripts, translate
);
...
export const bundleTheme = series(
    prodPrep, parallel(php, scripts, series( styles, editorStyles, adminStyles ), images), translate, prodStringReplace, prodCompress
);

/**
 * Export all imported functions as tasks
 */
export { generateCert, images, php, scripts, styles, editorStyles, adminStyles, translate, watch, cleanCSS, cleanJS };
