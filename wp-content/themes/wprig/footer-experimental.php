...
<footer data-gridarea="footer">
	...
	<div id="footer-social-media" data-gridarea="footer-social-media">

		<span class="social-media-icon-container">
			<!-- LINKEDIN ICON & LINK -->
			<a href="" title="Find Jones Sign Company on linkedin">
				<svg class="social-media-icon" id="linkedin-icon" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 480">

					<circle class="svg_icon_background" cx="240" cy="240" r="240"/>
					<g>
		...
		<!-- TWITTER ICON & LINK -->
		<span class="social-media-icon-container">
			<a href="" title="Find Jones Sign Company on twitter" class="social-media-icon">
		...
		<!-- FACEBOOK ICON & LINK -->
		<span class="social-media-icon-container">
			<a href="" title="Find Jones Sign Company on Faceboook" class="social-media-icon">
				<svg class="social-media-icon"
				version="1.1"
				id="facebook-icon"
				xmlns="http://www.w3.org/2000/svg"
		...
		<!-- WESCOVER ICON & LINK -->
		<span class="social-media-icon-container">
			<a href="https://www.wescover.com/creator/jones-sign-company" title="Find Jones Sign Company on WeScover" class=" social-media-icon">
				<svg class="social-media-icon"
				version="1.1"
				id="wescover-icon"
				xmlns="http://www.w3.org/2000/svg"
	...
	</div><!-- end div#footer-social-media -->

	<div data-gridarea="footer-copyright" id="footer-copyright" class="copyright">
		<div>
	...
	<div data-gridarea="footer-tagline" id="footer-tagline"><span><?= esc_html( get_bloginfo( 'description', 'display' ) ); ?></span> </div>
...
wp_nav_menu( array(
	...
	'menu'                 => 'expertise',
	'container'            => 'nav',
	'container_aria_label' => 'Expertise',
	'container_class'      => 'jones-footer-nav',
	'container_id'         => 'footer-menu-expertise',
	'items_wrap'           => '%3$s',
	'depth'                => 1,
) );
...
wp_nav_menu( array(
	...
	'menu'                 => 'signtypes',
	'container'            => 'nav',
	'container_aria_label' => 'Sign Types',
	'container_class'      => 'jones-footer-nav',
	'container_id'         => 'footer-menu-signtypes',
	'items_wrap'           => '%3$s',
	'depth'                => 1,
) );
...
wp_nav_menu( array(
	...
	'menu'                 => 'industries',
	'container'            => 'nav',
	'container_aria_label' => 'Industries',
	'container_class'      => 'jones-footer-nav',
	'container_id'         => 'footer-menu-industries',
	'items_wrap'           => '%3$s',
	'depth'                => 1,
) );
